...
**Claude Code equivalent:** `/kmgraph:kmg-capture-lesson`
...
**Claude Code equivalent:** `/kmgraph:kmg-capture-lesson` (with ADR category)
...
**Claude Code equivalent:** `/kmgraph:kmg-recall`
...
**Claude Code equivalent:** `/kmgraph:kmg-session-summary`
...
**Claude Code equivalent:** `/kmgraph:kmg-meta-issue`
