...
**Status:** ✅ Resolved (v0.6.17) — `.json`/`.jsonl` scoping shipped (`bf1cb51c`/`1b2269cf`); `.pb`/hash-dir fail-closed scoping shipped (`126d98ce`/`faa393d6`, governed by [ADR-062](../../../decisions/ADR-062-gemini-pb-project-scoping-fail-closed.md))
