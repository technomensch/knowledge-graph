...
- A docs site like MkDocs Material will have `docs/index.md`, `docs/assets/`, etc. but never `knowledge/lessons-learned/` or `knowledge/decisions/`
...
3. `knowledge/lessons-learned/` OR `knowledge/decisions/` exists at that path
...
2. Project with `knowledge/lessons-learned/` present - migration prompt fires correctly
3. Project with `knowledge/decisions/` only (lessons dir absent) - migration prompt fires correctly
...
**Session Reference:**
- knowledge/sessions/2026-04/2026-04-09-v0.3.0-beta-implementation-snapshot.md — Implementation context
