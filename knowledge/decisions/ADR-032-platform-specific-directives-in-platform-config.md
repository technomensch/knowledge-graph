...
**Superseded by:** `CLAUDE.md` at repo root is the platform config for Claude Code. Other platforms use their native files (`GEMINI.md`, `.cursorrules`, `AGENTS.md`). The `knowledge/platform/` directory is removed.
**Implements:** v0.3.5-beta
**Related:** [[ADR-028-me-and-rules-as-platform-agnostic-source-of-truth]] · [[ADR-017-four-layer-architecture-thin-commands]] · [[ADR-021-single-source-of-truth-dry-documentation]]
