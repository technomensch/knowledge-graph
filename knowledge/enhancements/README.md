...
- [ENH-064: Attribution README for Initialized Knowledge Graphs](ENH-064/ENH-064-specification.md) — **Status:** ✅ Resolved (pending PR) — GitHub #246. Auto-generate a README in every initialized knowledge graph pointing to KMGraph and explaining how a user who cloned/forked the repo without the plugin can install it and run `/kmgraph:kmg-init` to connect.
