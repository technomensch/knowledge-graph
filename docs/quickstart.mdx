...
Init also scaffolds `knowledge/me.md` (your identity and working style, gitignored) and `knowledge/rules.md` (project conventions, committed). These give any AI platform consistent context without platform-specific rewrites. See [Your AI Profile](pillars/portability/your-ai-profile.md).
