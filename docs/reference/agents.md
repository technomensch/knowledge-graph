...
| **knowledge-extractor** | Large-file parsing for KG extraction (never writes — coordinator writes after approval) | `--delegate knowledge-extractor` flag or auto for large operations |
