...
sidebar_label: Manual Workflows
description: "Step-by-step workflows for users without Claude Code: lessons, ADRs, chat extraction, search, sessions, meta-issues, patterns, maintenance, and MEMORY.md management"
---
...
> - Start with [Getting Started](../GETTING-STARTED.md#manual-setup)
> - Read [Concepts Guide](../CONCEPTS.md) for term definitions
> - Review [templates](../templates/) to understand structure

> **Using Claude Code?** Most of these workflows have a single command equivalent. See [COMMAND-GUIDE.md](../COMMAND-GUIDE.md).
...
> **What are templates?** See [Template](../CONCEPTS.md#template) in the Concepts Guide.
...
> **What is an ADR?** See [ADR](../CONCEPTS.md#adr-architecture-decision-record) in the Concepts Guide.
...
> **What is a session summary?** See [Session Summary](../CONCEPTS.md#session-summary) in the Concepts Guide.
...
> **What is a meta-issue?** See [Meta-Issue](../CONCEPTS.md#meta-issue) in the Concepts Guide.
...
> **What is MEMORY.md?** See [MEMORY.md](../CONCEPTS.md#memorymd) in the Concepts Guide.
...
- **Concepts:** [CONCEPTS.md](../CONCEPTS.md) — Plain-English term definitions
- **Examples:** [../examples/](../examples/) — Real-world samples to study
- **Templates:** [../templates/](../templates/) — Starting scaffolds
- **Command Guide:** [COMMAND-GUIDE.md](../COMMAND-GUIDE.md) — All commands (Claude Code users)
