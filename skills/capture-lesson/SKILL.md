...
### Step 1.6: Capture Git Metadata (v1.4 Feature) <!-- v1.4 Change -->
...
5. **Issue (optional):** Prompt for issue number or auto-detect from branch name (e.g., `fix/issue-41-auth` → issue #41)
