...
1. **Identify Mapping:** Map the Local ID to the GitHub Issue number using the `{active_kg_path}/issue-tracker.md` or the `GitHub Continuations` metadata in the plan.
   - *Note: GitHub #41 might map to Local issue-42. Do not assume identical numbering.*
...
| GitHub | [#YY] | Commented |
| PR | [#ZZ] | Description updated (if applicable) |
...
- [Three-Tier Sync Implementation](docs/lessons-learned/architecture/three-tier-sync.md) (PR #42, Issue #41)
  - Category: architecture
  - Pattern: Multi-tier configuration synchronization

- [Error Handling Best Practices](docs/lessons-learned/process/error-handling.md) (PR #42, Issue #41)
  - Category: process
